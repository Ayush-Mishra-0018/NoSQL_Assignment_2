...
public class StripeInMapper {
    ...
    public static class MapperClass
        ...
        private int d;
        private Map<String, MapWritableStripe> global = new HashMap<>();
        ...
        public void map(Object key, Text value, Context context) {
            ...
            for (int i = 0; i < words.length; i++) {
                ...
                MapWritableStripe stripe = global.getOrDefault(w, new MapWritableStripe());
        ...
        protected void cleanup(Context context)
            ...
            for (Map.Entry<String, MapWritableStripe> e : global.entrySet()) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(StripeInMapper.class);
